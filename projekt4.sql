...
DROP TRIGGER Objednavka_vytvorena_trigger;
CREATE TRIGGER Objednavka_vytvorena_trigger
...
-- procedura pro pridani odberu do objednavky
...
INSERT INTO Polozka_objednavky
VALUES(polozka_seq.NEXTVAL,2,2,'AB-',500);
...
-- Tato cast scriptu by se mela spustit druhym clenem tymu
DROP MATERIALIZED VIEW Darci_a_pocet_odberu;
-- VIEW Seznam všech dárců a počet jejich darování
